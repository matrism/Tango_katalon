...
module.exports.goToPreviewCWRTab = function () {
    it(
        "Go to preview CWR tab", function () {

            pages.work.clickPreviewCWRTab();

        }
    );
};
module.exports.goToRightsTab = function () {
    it(
        "Go to preview Rights tab", function () {

            pages.work.clickRightsTab();

        }
    );
};

module.exports.selectRegistrationRecipient = function (registrationRecipient) {
    it(
        "Select Registration Recipient " + registrationRecipient, function () {

            pages.work.typeRegistrationRecipientIntoInput(registrationRecipient);
            pages.work.selectValueFromDropdown();
...
module.exports.validateGeneratedOutput = function () {
    it(
        "Validate CWR is Displayed", function () {

            expect(pages.work.CWRTableIsDisplayed()).toBeTruthy();

        }
    );

};
module.exports.validateRightsDisplayed = function () {
    it(
        "Validate Rights Table is Displayed", function () {

            expect(pages.work.rightsTableIsDisplayed()).toBeTruthy();
