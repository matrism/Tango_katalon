    ...
    feature = [
        ...
        },
        {
            ...
            steps: [
                ...
                [steps.new_work.enterPrimaryWorkTitle, ['TEST COMPOSITE WORK ' + randomString(0)]],
                ...
                [steps.new_work.enterNewShellWork, [0, 'TEST SHELL WORK ' + randomString(0)]],
        ...
        },
        {
            ...
            steps: [
                ...
                [steps.new_work.goToNewWorkPage],
                [steps.new_work.enterPrimaryWorkTitle, ['TEST COMPOSITE WORK ' + randomString(1)]],
                [steps.new_work.clickCompositeWorkCheckbox],
                [steps.new_work.selectCompositeWorkType, ['Potpourri']],
                [steps.new_work.selectRandomCreator, [0]],
                [steps.new_work.enterCreatorContribution, [0, 50]],
                [steps.new_work.enterNewShellWork, [0, 'TEST SHELL WORK ' + randomString(1)]],
                [steps.new_work.enterComponentWorkAllocation, [0, 50]],
        ...
        },
        {
            ...
            steps: [
                ...
                [steps.new_work.goToNewWorkPage],
                [steps.new_work.enterPrimaryWorkTitle, ['TEST COMPOSITE WORK ' + randomString(2)]],
                [steps.new_work.clickCompositeWorkCheckbox],
                [steps.new_work.selectCompositeWorkType, ['Unspecified Composite']],
                [steps.new_work.selectRandomCreator, [0]],
                [steps.new_work.enterCreatorContribution, [0, 50]],
                [steps.new_work.enterNewShellWork, [0, 'TEST SHELL WORK ' + randomString(2)]],
                [steps.new_work.enterComponentWorkAllocation, [0, 50]],
                [steps.new_work.selectRandomShellWorkCreator, [0, 0]],
                [steps.new_work.enterShellWorkCreatorContribution, [0, 0, 100]],
                [steps.new_work.optToIncludeWorkOnWebsite, [false]],
        ...
        },
        {
            ...
            steps: [
                ...
                [steps.new_work.goToNewWorkPage],
                [steps.new_work.enterPrimaryWorkTitle, ['TEST COMPOSITE WORK ' + randomString(3)]],
                [steps.new_work.clickCompositeWorkCheckbox],
                [steps.new_work.selectCompositeWorkType, ['Medley']],
                [steps.new_work.enterNewShellWork, [0, 'TEST SHELL WORK ' + randomString(3.1)]],
                [steps.new_work.enterComponentWorkAllocation, [0, 50]],
                [steps.new_work.selectShellWorkCreatorFromPersonSlot, [0, 0, 0]],
                [steps.new_work.enterShellWorkCreatorContribution, [0, 0, 100]],
                [steps.new_work.enterNewShellWork, [1, 'TEST SHELL WORK ' + randomString(3.2)]],
        ...
        },
        {
            ...
            steps: [
                ...
                [steps.new_work.goToNewWorkPage],
                [steps.new_work.enterPrimaryWorkTitle, ['TEST COMPOSITE WORK ' + randomString(4)]],
                [steps.new_work.clickCompositeWorkCheckbox],
                [steps.new_work.selectCompositeWorkType, ['Composite of Samples']],
                [steps.new_work.selectRandomCreator, [0]],
                [steps.new_work.enterCreatorContribution, [0, 20]],
                [steps.new_work.enterNewShellWork, [0, 'TEST SHELL WORK ' + randomString(4.1)]],
                [steps.new_work.enterComponentWorkAllocation, [0, 20]],
                [steps.new_work.selectRandomShellWorkCreator, [0, 0]],
                [steps.new_work.enterShellWorkCreatorContribution, [0, 0, 100]],
                [steps.new_work.enterNewShellWork, [1, 'TEST SHELL WORK ' + randomString(4.2)]],
                [steps.new_work.enterComponentWorkAllocation, [1, 20]],
                [steps.new_work.selectRandomShellWorkCreator, [1, 0]],
                [steps.new_work.enterShellWorkCreatorContribution, [1, 0, 100]],
                [steps.new_work.enterNewShellWork, [2, 'TEST SHELL WORK ' + randomString(4.3)]],
                ...
                [steps.new_work.ensureTotalContributionTooLowMessageIsDisplayed],
                [steps.new_work.enterNewShellWork, [3, 'TEST SHELL WORK ' + randomString(4.5)]],
                ...
                [steps.new_work.goToNewWorkPage],
                [steps.new_work.enterPrimaryWorkTitle, ['TEST COMPOSITE WORK ' + randomString(5)]],
                [steps.new_work.clickCompositeWorkCheckbox],
                [steps.new_work.selectCompositeWorkType, ['Composite of Samples']],
                [steps.new_work.selectRandomCreator, [0]],
                [steps.new_work.enterCreatorContribution, [0, 65]],
                [steps.new_work.enterNewShellWork, [0, 'TEST SHELL WORK ' + randomString(5.1)]],
                [steps.new_work.enterComponentWorkAllocation, [0, 5]],
                [steps.new_work.selectRandomShellWorkCreator, [0, 0]],
                [steps.new_work.enterShellWorkCreatorContribution, [0, 0, 100]],
                [steps.new_work.enterNewShellWork, [1, 'TEST SHELL WORK ' + randomString(5.2)]],
                [steps.new_work.enterComponentWorkAllocation, [1, 6]],
                [steps.new_work.selectRandomShellWorkCreator, [1, 0]],
                [steps.new_work.enterShellWorkCreatorContribution, [1, 0, 100]],
                [steps.new_work.enterNewShellWork, [2, 'TEST SHELL WORK ' + randomString(5.3)]],
                [steps.new_work.enterComponentWorkAllocation, [2, 7]],
                [steps.new_work.selectRandomShellWorkCreator, [2, 0]],
                [steps.new_work.enterShellWorkCreatorContribution, [2, 0, 100]],
                [steps.new_work.enterNewShellWork, [3, 'TEST SHELL WORK ' + randomString(5.5)]],
                [steps.new_work.enterComponentWorkAllocation, [3, 8]],
                [steps.new_work.selectRandomShellWorkCreator, [3, 0]],
                [steps.new_work.enterShellWorkCreatorContribution, [3, 0, 100]],
                [steps.new_work.ensureTotalContributionTooLowMessageIsDisplayed],
                [steps.new_work.enterNewShellWork, [4, 'TEST SHELL WORK ' + randomString(5.6)]],
                ...
                [steps.new_work.goToNewWorkPage],
                [steps.new_work.enterPrimaryWorkTitle, ['TEST COMPOSITE WORK ' + randomString(6)]],
                [steps.new_work.clickCompositeWorkCheckbox],
                [steps.new_work.selectCompositeWorkType, ['Composite of Samples']],
                [steps.new_work.selectRandomCreator, [0]],
                [steps.new_work.enterCreatorContribution, [0, 64.147]],
                [steps.new_work.enterNewShellWork, [0, 'TEST SHELL WORK ' + randomString(6.1)]],
                [steps.new_work.enterComponentWorkAllocation, [0, 5.123]],
                [steps.new_work.selectRandomShellWorkCreator, [0, 0]],
                [steps.new_work.enterShellWorkCreatorContribution, [0, 0, 100]],
                [steps.new_work.enterNewShellWork, [1, 'TEST SHELL WORK ' + randomString(6.2)]],
                [steps.new_work.enterComponentWorkAllocation, [1, 10.321]],
                [steps.new_work.selectRandomShellWorkCreator, [1, 0]],
                [steps.new_work.enterShellWorkCreatorContribution, [1, 0, 100]],
                [steps.new_work.enterNewShellWork, [2, 'TEST SHELL WORK ' + randomString(6.3)]],
        ...
        },
        {
            ...
            steps: [
                ...
                [steps.new_work.goToNewWorkPage],
                [steps.new_work.enterPrimaryWorkTitle, ['TEST COMPOSITE WORK ' + randomString(7)]],
                [steps.new_work.clickCompositeWorkCheckbox],
                [steps.new_work.selectCompositeWorkType, ['Composite of Samples']],
                [steps.new_work.selectCreatorFromPersonSlot, [0, 0]],
                [steps.new_work.enterCreatorContribution, [0, 50]],
                [steps.new_work.enterNewShellWork, [0, 'TEST SHELL WORK ' + randomString(7.1)]],
                [steps.new_work.enterComponentWorkAllocation, [0, 50]],
                [steps.new_work.expectShellWorkTitleToMatchEnteredOne, [0]],
                [steps.new_work.selectShellWorkCreatorFromPersonSlot, [0, 0, 0]],
                [steps.new_work.enterShellWorkCreatorContribution, [0, 0, 100]],
