...
return incomeProviderInput.getText();
       ...
       getRRInputBorderLeftValue: function()
        ...
        getEffectiveStartDateContextualHelp:function()
        {
            ...
            //ptor.actions().
            //    mouseMove(effectiveStartDateContextualHelpIcon).
            //    perform();
            //    element(by.css(".rate-set-calendar>.control-label>i"))  .then(function hoverOverTooltip(tooltipIcon) {
            //
            //        browser.actions().mouseMove(tooltipIcon).perform();
            //        console.log("Azaza");
            //
            //    });
