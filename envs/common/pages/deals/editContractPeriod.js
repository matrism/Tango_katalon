...
if (pages.editDealContractPeriod === undefined) {
    exports = module.exports = pages.editDealContractPeriod = new ftf.pageObject({
        ...
        selectTheContractPeriodNumberI: function (i) {
            browser.wait(ExpectedConditions.visibilityOf(element(By.css("ul.deal-list li[ng-click='setActiveContractPeriod(cp.id)']:nth-child(" + i + ")"))));
        ...
        clickOnTheDeleteContractPeriodNumberI: function (i) {
            pages.base.scrollIntoView(element(by.css("ul.deal-list li[ng-click='setActiveContractPeriod(cp.id)']:nth-child(" + i + ")")));
            browser.actions().mouseMove(element(by.css("ul.deal-list li[ng-click='setActiveContractPeriod(cp.id)']:nth-child(" + i + ")"))).perform();
            browser.actions().mouseMove(element(by.css("ul.deal-list li[ng-click='setActiveContractPeriod(cp.id)']:nth-child(" + i + ") i.fa.fa-times.ng-scope"))).perform();
            browser.actions().click(element(by.css("ul.deal-list li[ng-click='setActiveContractPeriod(cp.id)']:nth-child(" + i + ") i.fa.fa-times.ng-scope"))).perform();
        },
