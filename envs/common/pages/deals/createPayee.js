...
if (pages.createDealPayee === undefined) {
    pages.createDealPayee = new ftf.pageObject({
        locators: {
            ...
            savePayeeFormButton: {css: "div[data-tg-modular-edit-id='newPayee'] div.CONTROLS.ng-scope button[data-ng-click='tgModularViewMethods.save();']"},
            cancelPayeeFormButton: {css: "div[data-tg-modular-edit-id='newPayee'] div.CONTROLS.ng-scope button.btn.btn-cancel.ng-binding.pull-left"},
        ...
        saveThePayeeForm: function () {
            pages.base.scrollIntoView(pages.createDealPayee.elems.savePayeeFormButton);
