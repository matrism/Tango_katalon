...
if (pages.headerDeal === undefined) {
    pages.headerDeal = exports = new ftf.pageObject({
        locators: {
            ...
            dealOwnershipValue: {css: "div.header-info div:nth-child(3) div.relative.clearfix.ownership div[data-tg-territory-label-static-contexts='MP_DEAL_SCOPE'] div.tg-territory-label"},
            ...
            dealAdministrationValue: {css: "div.header-info div:nth-child(3) div.relative.clearfix.administration div[data-tg-territory-label='headerView.territoriesOfAdministration'] div.tg-territory-label__list"},
