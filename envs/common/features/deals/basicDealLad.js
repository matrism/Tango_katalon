...
exports.feature = [
...

    {
        ...
        steps: function () {
            ...
            steps.editDealPayee.editClickOnAddPrimaryLinkForScopeNumberI(1);
            steps.editDealPayee.editSelectRandomPayeePersonFromDropDown("teste1, teste");
    ...
    //
    //{
    //    name: "Create a deal payees for old environment",
    //    tags: ["oldPayeeLadTest"],
    //    steps: function () {
    //        var timeout = 100000;
    //        //steps.searchSection.accessSavedDealByNumber("20615");
    //
    //        steps.createDealGeneral.itFillDealMandatoryFieldsGeneralTab();
    //        steps.deal.itContinueToNextPage();
    //        //add 3 contract periods
    ...
    //        steps.editDealPayee.editSelectSpecificOldPayeePersonFromDropDown("person " + 1 + ", TAT payee");
    //        steps.editDealPayee.editSelectRandomValueForOldPayeeCompanyNameCode();
    //        for (var i = 1; i <= 3; i++) {
    //            steps.editDealPayee.editAssociateSpecificScopeNumberIToOldPayee(i);
    //            steps.editDealPayee.editFillIntoPayeeLegalRightInputFieldScopeNumberI(i);
    //            steps.editDealPayee.editFillIntoPayeeDistributionInputFieldScopeNumberI(i);
    //        }
    //        steps.editDealPayee.editSavePayeePage();
    //
    //
    //        for (var j = 2; j <= 200; j++) {
    //            steps.editDealPayee.editOldPayeeArea();
    //            steps.editDealPayee.editSelectSpecificOldPayeePersonFromDropDown("person " + j + ", TAT payee");
    //            steps.editDealPayee.editSelectRandomValueForOldPayeeCompanyNameCode();
    //            for (var i = 3 * j; i >= 3 * j - 2; i--) {
    //                var k = 1;
    //                steps.editDealPayee.editAssociateSpecificScopeNumberIToOldPayee(i);
    //                steps.editDealPayee.editFillIntoPayeeLegalRightInputFieldScopeNumberI(k);
    //                steps.editDealPayee.editFillIntoPayeeDistributionInputFieldScopeNumberI(k);
    //                k = k + 1;
    //            }
    //            steps.editDealPayee.editSavePayeePage();
    //        }
