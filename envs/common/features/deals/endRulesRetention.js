...
exports.feature = [
    ...
    },
    {
        ...
        steps: function () {
            ...
            steps.endRulesRetention.selectRightVariableEndRulesSpecificValueRuleNumberIRowNumberJ(1, 2, "Target End Date");
            steps.endRulesRetention.checkSummaryTextForEndRulesRuleNumberI(1, "If Balance Repaid at 32% is before the Recouped Date, and Recouped at 30% (with notice) is after [Variable Right] ..., then the Actual End Date is the Retention Period Start offset by 21 days.");
            steps.endRulesRetention.clickOnAddNewRuleEndRulesAddedRuleNumberI(1);
            steps.endRulesRetention.checkSummaryTextForEndRulesRuleNumberI(1, "If [Variable Left] ... [Requirement] [Variable Right] ..., and Balance Repaid at 32% is before the Recouped Date, and Recouped at 30% (with notice) is after [Variable Right] ..., then the Actual End Date is the Retention Period Start offset by 21 days.");
            steps.endRulesRetention.selectWhenVariableLeftEndRulesSpecificValueRuleNumberIRowNumberJ(1, 1, "Balance Repaid");
            ...
            steps.endRulesRetention.fillIntoAttributeRightEndRulesSpecificValueRuleNumberIRowNumberJ(1, 1, "2014-12-08");
            steps.endRulesRetention.clickOnEndRulesArea();
            steps.endRulesRetention.checkSummaryTextForEndRulesRuleNumberI(1, "If Balance Repaid at 30% is on 2014-12-08, and Balance Repaid at 32% is before the Recouped Date, and Recouped at 30% (with notice) is after [Variable Right] ..., then the Actual End Date is the Retention Period Start offset by 21 days.");
            steps.endRulesRetention.deleteEndRulesConditionNumberIRowNumberJ(1, 1);
            steps.endRulesRetention.deleteEndRulesConditionNumberIRowNumberJ(1, 2);
            steps.endRulesRetention.checkSummaryTextForEndRulesRuleNumberI(1, "If Balance Repaid at 32% is before the Recouped Date, then the Actual End Date is the Retention Period Start offset by 21 days.");
