...
exports.feature = [
    {
        ...
        steps: function () {
            ...
            steps.editDealScope.selectScopeNumberI(10);
            steps.editDealScope.selectScopeNumberI(1);
            steps.royaltyRates.editRoyaltyRate();
            steps.royaltyRates.addEffectiveStartDate("2016-08-09");
            steps.royaltyRates.clickDoneButtonForRRSet();
            steps.editDealScope.selectScopeNumberI(1);
            steps.editDealScope.checkTheScopeRateSetDate("2016-08-09");
            steps.editDealScope.selectScopeNumberI(10);
            steps.editDealScope.selectScopeNumberI(17);
            steps.editDealScope.checkTheScopeRateSetDateNotEqual("2016-08-09");
            steps.editDealScope.selectScopeNumberI(18);
            steps.editDealScope.checkTheScopeRateSetDateNotEqual("2016-08-09");
            steps.editDealScope.selectScopeNumberI(19);
            steps.editDealScope.checkTheScopeRateSetDateNotEqual("2016-08-09");
